...
-(UILocalizedIndexedCollation *)addbookSort:(NSMutableArray*)personArr
{
        ...
        for (JHPersonModel *addressBook in personArr) {
...
-(NSMutableArray*)getAllPerson
{
        ...
        for (NSInteger i = 0; i < nPeople; i++)
            {
        JHPersonModel *addressBook = [[JHPersonModel alloc] init];
        ...
        for (JHPersonModel *addressBook in addressBookTemp) {
        ...
        for (NSMutableArray *sectionArray in sectionArrays) {
            ...
            JHPersonModel *person=(JHPersonModel*)sectionArray.firstObject;
