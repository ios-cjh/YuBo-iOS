...
@objc protocol WaterfallLayoutDataSource : class {
    ...
    @objc optional func numberOfColsInWaterfallLayout(_ layout : JHWaterfallLayout) -> Int
}


class JHWaterfallLayout :UICollectionViewFlowLayout{
    // MARK: 对外提供属性
